  ...
  return (
    <section className="w-full h-dvh flex pt-[100px] px-0 pb-[75px] top-0 bottom-0 relative">
      <div className='flex flex-col max-w-[460px] h-full pt-[10vh] px-0 pb-0 '>
        ...
        <p className='mx-10 my-4 max-w-60 gap-8 flex flex-col items-start justify-items-center font-medium text-[11px] leading-tight tracking-wide text-[#111]'>this is my portfolio thank you for visiting my site thank you.this is my portfolio thank you for visiting my site thank you.
          <a href='/' className='pt-4 pb-[10px] px-7 text-white bg-black relative min-w-[16px] text-center text-sm leading-tight font-semibold'>click my profile</a>
        </p>
