  ...
  return (
    <section className="w-full h-dvh flex flex-col pt-[100px] pl-10 pb-[75px] !left-0 top-0 bottom-0 start-[--h-padding] end-[--h-padding] relative overflow-hidden">
      ...
      <div className="absolute left-0 bottom-0 right-0 h-[1000px] overflow-hidden">
        <Bubble2 x={220} y={620} xLg={668} yLg={380}>
          HTML
        </Bubble2>
        <Bubble x={400} y={580} xLg={821} yLg={512}>
          CSS
        </Bubble>
        <Bubble x={170} y={770} xLg={552} yLg={553}>
          JavaScript
        </Bubble>
        <Bubble x={1031} y={619}>
          jQuery
        </Bubble>
        <Bubble2 x={1500} y={1500} xLg={264} yLg={656}>
          Photoshop
        </Bubble2>
        <Bubble x={871} y={720}>
          Illustrator
        ...
        <Bubble x={1500} y={1500} xLg={502} yLg={836}>
          Fiber
        </Bubble>
        <Bubble x={1031} y={881}>
          Drei
