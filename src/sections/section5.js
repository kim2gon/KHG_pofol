...
const Section5 = () => {
  const pofolimg = [eximg1, eximg2, eximg3, eximg4, eximg5, eximg6];
  return (
    < section className='w-full h-dvh flex pt-[100px] pl-10 pb-[75px] !left-0 top-0 bottom-0 start-[--h-padding] end-[--h-padding] relative' >
        ...
        <div className='w-full h-full fixed'>
          <div className='top-full flex-col absolute flex slide-up'>
            <div className='w-full'>
              {pofolimg.map((v, i) => (
                <img key={v} src={v} className='block mt-[91px] object-cover w-[324px] h-[404px]' />
              ))}
            </div>
          </div>
        </div>
      ...
      <div className='w-full h-full fixed'>
          <div className='top-full flex-col absolute flex slide-down'>
            <div className='w-full'>
              {pofolimg.map((v, i) => (
                <img key={v} src={v} className='block mt-[91px] object-cover w-[324px] h-[404px]' />
              ))}
