...
const Section5 = () => {
  const cssanimation = [
    aniimg1, aniimg2, aniimg3, aniimg4, aniimg5, aniimg6, aniimg1, aniimg2, aniimg3, aniimg4, aniimg5, aniimg6
  ];
  // 12*2 24개 애니메이션 반복
  ...
  return (
    <section className='w-full h-dvh flex pt-[100px] pl-10 pb-[75px] !left-0 top-0 bottom-0 start-[--h-padding] end-[--h-padding] relative'>
      <p className='mt-[15vh] m-0 max-w-60 font-medium text-[11px] leading-[18px] tracking-wide text-[#111]'>
        ...
        <Link href='/' className='block max-w-max min-w-40 mt-8 cursor-pointer font-semibold text-xs leading-tight text-center realative text-white pt-4 px-[30px] pb-[11px] bg-black'>
          click my profile
        </Link>
      </p>
