    ...
    <section className="w-full h-dvh flex pt-[100px] px-0 pb-[75px] top-0 bottom-0 relative">
      <div className="mt-auto mr-0 mb-[5px] ml-10">
        <div className='flex flex-col gap-7 w-60'>
          ...
          <p className='m-0 max-w-60 gap-8 flex flex-col items-start font-medium text-[11px] leading-tight tracking-wide text-[#111]'>this is my portfolio thank you for visiting my site thank you.this is my portfolio thank you for visiting my site thank you.</p>
        </div>
      </div>
      <div className='w-[100vw] translate-y-0 fixed mt-[100px] left-0 right-0 pt-[53px] pr-[232px] pb-[50px] pl-[159px] bg-black text-white z-10'>
        <div className='font-medium text-[34px] leading-tight tracking-wide max-w-[1250px]'>
          <p>this is my portfolio thank you for visiting my site thank you.this is my portfolio thank you for visiting my site thank you.
            this is my portfolio thank you for visiting my site thank you.this is my portfolio thank you for visiting my site thank you.</p>
        </div>
      </div>
    </section>
  )
